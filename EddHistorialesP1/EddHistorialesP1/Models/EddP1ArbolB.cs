...
namespace EddHistorialesP1.Models
{
    public class EddP1ArbolB
    {
        ...
        public void ingresar(nodoArbolB clave, EddP1PaginaArbolB raiz)
        {
            ...
            System.Diagnostics.Debug.WriteLine("inserción correcta de nodo :) ->"+P.claves[0].idT);
        }
        ...
        //incerta una nueva pagina de tipo oja
        public void insertaHoja(nodoArbolB clave, EddP1PaginaArbolB raiz, int k)
        {
            ...
            raiz.claves[k] = clave;
            System.Diagnostics.Debug.WriteLine("se incertó la nueva clave "+raiz.claves[k].idT+" en la posición "+k);
            raiz.ramas[k + 1] = xr;
        ...
        public void dividirN(nodoArbolB clave, EddP1PaginaArbolB raiz, int k)
        {
            ...
            EddP1PaginaArbolB mDer = new EddP1PaginaArbolB();
            pos = posmda + 1;
            while (pos != 5)
            {
            ...
            {
                insertaHoja(clave, mDer, (k - posmda));
            }
        ...
        System.Diagnostics.Debug.WriteLine("se encontró el elemento en la posición "+j+"de la pagina");
        return j;
        }

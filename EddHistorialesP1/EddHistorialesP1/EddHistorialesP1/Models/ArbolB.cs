...
namespace EddHistorialesP1.Models
{
        ...
        public void insertar(EddP1PaginaArbolB raiz, nodoArbolB clave)
	{
        ...
        public nodoArbolB BuscarNodo(int codigo)
        {
            return BuscarNodo(codigo, this.raiz);
        }

        private nodoArbolB BuscarNodo(int codigo, EddP1PaginaArbolB raiz)
        {
            ...
            else
            {
                ...
                if (codigo < int.Parse(raiz.claves[0].idT))
                {
                ...
                else
                {
                    ...
                    while (codigo < int.Parse(raiz.claves[limite - 1].idT))
                    {
                        limite--;
                    }
                    //VALIDAMOS SI ES IGUAL A LA CLAVE
                    if (codigo == int.Parse(raiz.claves[limite - 1].idT))
                    {
